...
async function replyUvOnly(replyToken, token, env) {
  ...
  function uvAdvice(n) {
    ...
    if (n <= 7) return "🌡️容易曬傷，更要擦🧴青春防曬 還要多補充水份或🍺芒果茶 最好還能帶個帽子或陽傘";
    if (n <= 10) return "🚨曝曬風險高，盡量避開中午外出 擦🧴青春防曬 還要多補充水份或🍺芒果茶 帶個帽子或陽傘";
    return "🚨紫外線危險級，減少曝曬並加強遮蔽 擦🧴青春防曬 還要多補充水份或🍺芒果茶 帶個帽子或陽傘 晚上記得厚敷平泰秀呀 ";
  }
